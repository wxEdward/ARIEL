...
from dataset import SPMotif, augment
...
if __name__ == '__main__':
    ...
    epochs = 20
    log_interval = 10
    batch_size = 32 if args.DS == "DD" else 128
    # batch_size = 512
    lr = args.lr
    DS = args.DS
    '''
    ...
    for epoch in range(1, epochs+1):
        ...
        for data in dataloader:
            ...
            # print('start')
            data, data_aug = augment(deepcopy(data))
            optimizer.zero_grad()
            ...
            if args.aug == 'dnodes' or args.aug == 'subgraph' or args.aug == 'random2' or args.aug == 'random3' or args.aug == 'random4' or args.aug == 'random5':
            ...
            x_aug = model(data_aug.x, edge2adj(data_aug.x, data_aug.edge_index), data_aug.batch, data_aug.num_graphs)

            A_adv, X_adv = PGD_attack_graph(model, data, data_aug, 5, 0.1, args.alpha, args.beta)
            if args.eps > 0:
                x_adv = model(X_adv, A_adv, data.batch, data.num_graphs)

            loss = model.loss_cal(x, x_aug)
            if args.eps > 0:
                loss_adv = model.loss_cal(x_adv, x_aug)
                loss += args.eps*loss_adv
            print(loss.item())
    ...
    with open('logs/log_' + args.DS + '_' + args.aug, 'a+') as f:
        ...
        f.write('{},{},{},{},{},{}\n'.format(args.DS, epochs, s, args.eps, args.alpha, args.beta))
        f.write('\n')
